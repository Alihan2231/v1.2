...
class SpotifyARPApp:
    ...
    def start_periodic_scan(self, interval_hours=24):
        ...
        if hasattr(self, 'scanner'):
            ...
            if result:
                print(f"Periyodik tarama başlatıldı - Her {interval_hours} saatte bir")
                # Periyodik tarama durumunu global değişkene kaydet
                global periodic_scan_active
                if 'periodic_scan_active' in globals():
                    periodic_scan_active.set()
            return result
        return False
